...
<%
	...
	List<StoreVO> list = storeSvc.getOpenStore();
...
<%-- 							<img src="<%=request.getContextPath()%>/photo_read/photo_read.do?photo_no=${storeSvc2.getFirstPhoto(store_no)}" class="img-responsive" alt=""> --%>
				...
				<div class="col-md-8">
					<h3 style="color:#d15a15">${storeVO.store_name}</h3>
						<hr style="border: 1px solid #ccc;" size="1">
						...
						<div class="btn-left" style="float:right">
...
<div style="text-align:center"><%@ include file="pages/page2.file" %></div>			
		</div>
	</div>
</div>
<!-- about -->	
