...
<c:if test="${not empty errorMsgs}">
	...
	<div class="row">
		<h3>新增廣告表單</h3>
		<div class="col-md-4">
			<img id="pic_preview" src="<%=request.getContextPath()%>/back-end/advertisement/ImageAd" class="img-responsive"/>
		</div>		
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class = "col-sm-6"> 
				<input type="text" class="form-control" id="ad_imagetitle" name="ad_imagetitle" value="${addAdvertisementVO.ad_imagetitle}">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-3" for="ad_startdate">開始日期</label>
				<div class = "col-sm-4"> 
				<input type="text" class="form-control" id="ad_startdate" name="ad_startdate" value="${addAdvertisementVO.ad_startdate}">
				</div>
				</div>
				<div class="form-group">
				<label class="control-label col-sm-3" for="ad_enddate">結束日期</label>
				<div class = "col-sm-4"> 
				<input type="text" class="form-control" id="ad_enddate" name="ad_enddate" value="${addAdvertisementVO.ad_enddate}">
				</div>
			</div>
			<div class="form-group">
				...
				<jsp:useBean id="storeSvc" scope="page" class="com.store.model.StoreService" />
					<select class="form-control" name="store_no">
						<c:forEach var="storeVO" items="${storeSvc.all}">
							<option value="${storeVO.store_no}" ${(storeVO.store_no==addAdvertisementVO.store_no)?'selected':''}>${storeVO.store_name}</option>
						</c:forEach>
					</select>
				</div>
			</div>
